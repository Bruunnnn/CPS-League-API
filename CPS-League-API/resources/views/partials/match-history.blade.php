        ...
        <div class="match-main">
            ...
            <div class="items-grid">
                <div class="items-row">
                    ...
                    @if ($item)
                    <img class="item-icon" src="https://ddragon.leagueoflegends.com/cdn/{{ $latestPatch }}/img/item/{{ $item }}.png" alt="Item {{ $item }}">
            ...
            <div class="champion-spells">
                <div class="spells-side">
                    ...
                    <img class="summoner-icon"
                         src="https://ddragon.leagueoflegends.com/cdn/{{ $latestPatch }}/img/spell/{{ $summonerSpellMap[$match->summoner1Id] }}.png"
                         alt="Spell 1">
                    @endif

                    @if (isset($summonerSpellMap[$match->summoner2Id]))
                    <img class="summoner-icon"
                         src="https://ddragon.leagueoflegends.com/cdn/{{ $latestPatch }}/img/spell/{{ $summonerSpellMap[$match->summoner2Id] }}.png"
                         alt="Spell 2">
                    @endif
                </div>
            </div>
